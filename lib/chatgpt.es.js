...
function d(o) {
  if (u)
    return;
  u = !0;
  var s = "https://chat.openai.com/?prompt={prompt}&form={form}", a = navigator.language.substr(0, 2), r = "";
  function l(i) {
    let e = r || a;
  ...
  n.id = "gen-btn", n.href = "javascript:;", n.title = l("title"), n.style = "position: fixed; bottom: 50%; right: 20px; z-index: 9999; width: 32px; height: 32px; border: none; cursor: pointer;", n.innerHTML = h, document.body.appendChild(n), n.addEventListener("click", () => {
    ...
    t.id = "tooltip", t.style.display = "none", t.style.position = "fixed", t.style.zIndex = "9999", t.style.bottom = "50%", t.style.right = "100px", t.style.backgroundColor = "#74aa9c", t.style.color = "white", t.style.padding = "10px", t.style.borderRadius = "5px", t.style.opacity = "0", t.style.transition = "opacity 0.3s", t.innerText = l("copy"), document.body.appendChild(t), t.style.display = "block", t.style.opacity = "1", t.onclick = () => {
      t.style.opacity = "0", setTimeout(() => {
        ...
        c.style.display = "none", c.href = s.replace("{form}", encodeURIComponent(i)).replace("{prompt}", encodeURIComponent(e)), c.target = "_blank", c.click();
      }, 300);
    };
